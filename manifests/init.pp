...
#
class dns (
  Pattern[/^(([a-zA-Z]:[\\\/])|([\\\/][\\\/][^\\\/]+[\\\/][^\\\/]+)|([\\\/][\\\/]\?[\\\/][^\\\/]+))/, /^\/([^\/\0]+\/*)+$/]   $namedconf_path        = $::dns::params::namedconf_path,
  Pattern[/^(([a-zA-Z]:[\\\/])|([\\\/][\\\/][^\\\/]+[\\\/][^\\\/]+)|([\\\/][\\\/]\?[\\\/][^\\\/]+))/, /^\/([^\/\0]+\/*)+$/]   $dnsdir                = $::dns::params::dnsdir,
  Pattern[/^(([a-zA-Z]:[\\\/])|([\\\/][\\\/][^\\\/]+[\\\/][^\\\/]+)|([\\\/][\\\/]\?[\\\/][^\\\/]+))/, /^\/([^\/\0]+\/*)+$/]   $rndckeypath           = $::dns::params::rndckeypath,
  Pattern[/^(([a-zA-Z]:[\\\/])|([\\\/][\\\/][^\\\/]+[\\\/][^\\\/]+)|([\\\/][\\\/]\?[\\\/][^\\\/]+))/, /^\/([^\/\0]+\/*)+$/]   $optionspath           = $::dns::params::optionspath,
  Pattern[/^(([a-zA-Z]:[\\\/])|([\\\/][\\\/][^\\\/]+[\\\/][^\\\/]+)|([\\\/][\\\/]\?[\\\/][^\\\/]+))/, /^\/([^\/\0]+\/*)+$/]   $publicviewpath        = $::dns::params::publicviewpath,
  Pattern[/^(([a-zA-Z]:[\\\/])|([\\\/][\\\/][^\\\/]+[\\\/][^\\\/]+)|([\\\/][\\\/]\?[\\\/][^\\\/]+))/, /^\/([^\/\0]+\/*)+$/]   $vardir                = $::dns::params::vardir,
  Pattern[/^(([a-zA-Z]:[\\\/])|([\\\/][\\\/][^\\\/]+[\\\/][^\\\/]+)|([\\\/][\\\/]\?[\\\/][^\\\/]+))/, /^\/([^\/\0]+\/*)+$/]   $zonefilepath          = $::dns::params::zonefilepath,
